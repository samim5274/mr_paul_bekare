        ...
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url('/branch-transfer')}}">Transfer</a></li>
            ...
            <div class="container mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="m-0">Branch to Branch Transfer Report</h4>
                    ...
                    <div class="col-lg-12 col-md-12 grid-margin stretch-card">
                        <div class="card mt-2">
                            <div class="card-body p-2 p-md-4">
                                <form action="{{url('/search-transfer-stock')}}" method="POST" target="_blank">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-4">
                    ...
                    <table class="table table-bordered table-striped" id="printableTable">
                        <thead class="table-primary">
                            <tr>
                                ...
                                <th>Name</th>
                                <th class="text-center"  style="width: 130px">Branch</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$val->branch->name}}</td>
